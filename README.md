...
crDroid 10.x (A14/T) for Redmi K30 5G (picasso)
======================================
...
https://github.com/masemoel/local_manifests/blob/master/picasso_u.xml

Then go to the source folder and run:

```bash
. build/envsetup.sh
lunch lineage_picasso-userdebug && mka bacon -j 16
```
